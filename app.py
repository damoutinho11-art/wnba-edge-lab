...
<div class="topbar"><div class="top-inner"><div class="brand-row"><div class="logo"><div class="logo-mark"><svg viewBox="0 0 40 40" fill="none"><polygon points="20,2 36,11 36,29 20,38 4,29 4,11" fill="none" stroke="url(#lg1)" stroke-width="1.4"/><polygon points="20,9 30,15 30,25 20,31 10,25 10,15" fill="url(#lg2)" opacity=".12"/><defs><linearGradient id="lg1" x1="4" y1="2" x2="36" y2="38" gradientUnits="userSpaceOnUse"><stop stop-color="#00c8f0"/><stop offset="1" stop-color="#8b5cf6"/></linearGradient><linearGradient id="lg2" x1="10" y1="9" x2="30" y2="31" gradientUnits="userSpaceOnUse"><stop stop-color="#00c8f0"/><stop offset="1" stop-color="#8b5cf6"/></linearGradient></defs></svg><span>W</span></div><div class="logo-text"><h1>WNBA <em>Edge Lab</em></h1><p>v19.2 · precision system · hermes OS</p></div></div><div class="status-pill"><span class="dot"></span>MANUAL APPROVAL</div></div><nav class="nav">{nav_html}</nav></div></div>
<main class="shell">{body}<div class="footer">public site · operator terminal · {title}</div></main>
<script>
...
.footer::after{content:" · v19.4 signal execution · manual approval"!important;color:rgba(0,200,240,.68)!important}
...
def v19_menu():
    ...
    return f'<div class="v19-section-head"><div><h2>Full lab menu</h2><p>Clean top navigation, grouped access to every deep route.</p></div><span class="chip">V19.4</span></div><div class="menu-group-grid">{"".join(sections)}</div>'
...
if __name__ == "__main__":
    print("Starting WNBA Edge Lab v19.4 signal execution bankroll...")
